...
public class Robot extends IterativeRobot {
    ...
    public SpeedControllerGroup left = new SpeedControllerGroup(frontLeft, backRight);
  ...
  public void teleopPeriodic() {
    ...
    double driveSpeed = (joystickDrive.getY(Hand.kLeft));
    double driveRot = (joystickDrive.getX(Hand.kLeft));
    drive.arcadeDrive(-(driveSpeed*0.6), (driveRot*0.6));
  }
